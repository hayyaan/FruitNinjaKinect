...
MODEL              = Fruit
MODULES            = Fruit_acc_data.c HostLib_Multimedia.c HostLib_Video.c HostLib_rtw.c rtGetInf.c rtGetNaN.c rt_nonfinite.c openNI_wrapper.cpp wrapper_common.cpp 
MAKEFILE           = Fruit.mk
...
MASTER_ANCHOR_DIR  = 
START_DIR          = C:\Users\Hayyaan\Desktop\PRJ\Fruit
S_FUNCTIONS        = sf_sfun.c sfun_nid.cpp
S_FUNCTIONS_LIB    = "C:\Program Files\OpenNI\Lib64\openNI64.lib"
SOLVER             = 
NUMST              = 2
TID01EQ            = 0
NCSTATES           = 0
...
SHARED_BIN_DIR     = 
SHARED_LIB         = 
MEX_OPT_FILE       = -f C:\Users\Hayyaan\AppData\Roaming\MATHWO~1\MATLAB\R2011a\mexopts.bat
COMPUTER           = PCWIN64
VISUAL_VER         = 10.0
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\toolbox\shared\multimedia\include
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\slprj\accel\Fruit
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\Users\Hayyaan\Desktop\PRJ\simulink_nid_0.4.0\slnid\Lib
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\PROGRA~1\OpenNI\Include
...
{$(MATLAB_ROOT)\toolbox\dsp\include}.c.obj :
	@echo ### Compiling $<
	$(CC) $(MEX_FLAGS) $<
...
{C:\Users\Hayyaan\Desktop\PRJ\simulink_nid_0.4.0\slnid\Lib}.c.obj :
	@echo ### Compiling $<
	$(CC) $(MEX_FLAGS) $<
...
{$(MATLAB_ROOT)\toolbox\dsp\include}.cpp.obj : 
	@echo ### Compiling $< 
	$(CC) $(MEX_FLAGS) $< 
...
{C:\Users\Hayyaan\Desktop\PRJ\simulink_nid_0.4.0\slnid\Lib}.cpp.obj : 
	@echo ### Compiling $< 
	$(CC) $(MEX_FLAGS) $< 
